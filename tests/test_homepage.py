...
class TestHomePage:
    ...
    def test_nav_links_text(self):
        """
        Проверка на получение данных виде strings "Header"
        """
    ...
    def test_click_nav_links(self):
        """
        Проверка ссылок на нажатия "Header"
        """
        home_page_nav = HomePage(self.driver)
    ...
    def test_catalog_product_text(self):
        '''
        Проверка на получение данных виде string "Категории"
        '''
        home_page_nav = HomePage(self.driver)
    ...
    def test_click_catalog_product(self):
        '''
        Проверка ссылок на нажатия "Категории"
        '''
        home_page_nav = HomePage(self.driver)
    ...
    def test_search_write(self):
        '''
        Проверка поисковика на получение данных,
        и проверка данных полученных по запросу "Поисковик"
        '''
    ...
    def test_language_choice(self):
        '''
        Проверка на изменение языка "language"
        '''
    ...
    def test_catalog_type_text(self):
        '''
        Проверка на получение данных виде strings "Под категории"
        '''
    ...
    def test_catalog_type_click(self):
        '''
        Проверка ссылок на нажатия "Под категории"
        '''
